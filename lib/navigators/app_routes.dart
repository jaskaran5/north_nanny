...
/// routes in [AppPages].
class Routes {
  static const String splash = Paths.splashPath;
  static const String chooseBabySitter = Paths.chooseBabySitter;
...
class Paths {
  ...
  static const String chooseBabySitter = '/choose-baby-sitter';

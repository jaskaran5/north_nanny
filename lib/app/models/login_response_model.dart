...
LoginResponseDataModel loginResponseDataModelFromJson(String str) =>
    LoginResponseDataModel.fromJson(json.decode(str));

String loginResponseDataModelToJson(LoginResponseDataModel data) =>
